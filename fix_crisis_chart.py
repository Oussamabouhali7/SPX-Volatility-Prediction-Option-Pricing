...
old = """      {/* TAB 2 â€” Crisis split */}
      {tab === 2 && (
        <Paper sx={{ p: 2 }}>
          <Typography variant=\"h4\" sx={{ mb: 2 }}>
            StabilitÃ© temporelle : Subprimes (2007-09) â†’ COVID (2020)
          </Typography>
          <Alert severity=\"info\" sx={{ mb: 2 }}>
            ModÃ¨les entraÃ®nÃ©s sur les Subprimes et validÃ©s sur la crise COVID :
            un ratio RMSE_COVID / RMSE_Subprimes proche de 1 indique un modÃ¨le robuste.
          </Alert>
          <Table size=\"small\">
            <TableHead>
              <TableRow>
                <TableCell><strong>ModÃ¨le</strong></TableCell>
...
new = """      {/* TAB 2 â€” Crisis split */}
      {tab === 2 && (() => {
        ...
        const metricLabels = { rmse: 'RMSE', mae: 'MAE', r2: 'RÂ²', mape: 'MAPE', directional_accuracy: 'Dir. Accuracy' };

        return (
          <Box>
            <Alert severity=\"info\" sx={{ mb: 2 }}>
              ModÃ¨les entraÃ®nÃ©s sur les Subprimes (2007-2009) et validÃ©s sur COVID (2020).
              Un ratio RMSE COVID / RMSE Subprimes proche de 1 = modÃ¨le robuste.
            </Alert>

            {/* Selecteur metrique */}
            <TextField select label=\"MÃ©trique\" value={crisisMetric}
            ...
            {/* Histogramme groupÃ© Train / Test Subprimes / Val COVID */}
            <Paper sx={{ p: 2, mb: 3 }}>
              <Typography variant=\"h4\" sx={{ mb: 1 }}>
                {metricLabels[crisisMetric]} par modÃ¨le â€” Train vs Test Subprimes vs Val COVID
              </Typography>
              <Plot
                data={[
                  {
                ...
                layout={{
                  ...
                  autosize: true,
                  height: 480,
                  xaxis: { title: 'ModÃ¨le', tickangle: -20 },
            ...
            <Paper sx={{ p: 2 }}>
              <Typography variant=\"h4\" sx={{ mb: 2 }}>Tableau â€” RMSE Subprimes vs COVID</Typography>
              <Table size=\"small\">
                <TableHead>
                  <TableRow>
                    <TableCell><strong>ModÃ¨le</strong></TableCell>
