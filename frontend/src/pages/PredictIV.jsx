// pages/PredictIV.jsx — Onglet 1 : Prédiction de la volatilité implicite
...
export default function PredictIV() {
  ...
  return (
    <Box>
      <Typography variant="h1" gutterBottom>Prédiction de la volatilité implicite</Typography>
      <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
        Selectionnez un point (moneyness, maturité) et comparez les prédictions des modèles.
      </Typography>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3 }}>
            ...
            <TextField fullWidth label="Maturité (jours)" type="number"
            ...
            <Box sx={{ mt: 3, mb: 1 }}>
              ...
              <Typography variant="caption" color="text.secondary">
                RMSE affiché = moyenne sur les {form.n_windows} premières fenêtres
              </Typography>
            </Box>
            ...
            <Button fullWidth variant="contained"
              ...
              {loading ? <CircularProgress size={20} color="inherit" /> : 'Prédire IV'}
            </Button>
          ...
          <Paper sx={{ p: 3, minHeight: 500 }}>
            ...
            {!result && (
              <Box sx={{ p: 6, textAlign: 'center', color: 'text.secondary' }}>
                <Typography>Lancez une prédiction pour voir les résultats.</Typography>
              </Box>
            )}
              ...
              <>
                {invalidPreds.length > 0 && (
                  <Alert severity="warning" sx={{ mb: 2 }}>
                    {invalidPreds.length} modèle(s) avec valeurs aberrantes exclus du graphique :
                ...
                {validPreds.length > 0 && (
                  <Box sx={{ height: 300, mb: 2 }}>
                    <Plot
                      ...
                      layout={{
                        autosize: true,
                        yaxis: { title: 'IV prédite', tickformat: '.1%' },
                        xaxis: { tickangle: -30 },
                ...
                <Table size="small">
                  <TableHead>
                    <TableRow sx={{ bgcolor: PWC_COLORS.orange + '10' }}>
                      ...
                      <TableCell align="right"><strong>IV prédite</strong></TableCell>
                      <TableCell align="right"><strong>%</strong></TableCell>
                      <TableCell align="right"><strong>RMSE ({form.n_windows} fen.)</strong></TableCell>
                      ...
                      return (
                        <TableRow key={name}
                          ...
                          <TableCell align="right"
                            sx={{ color: valid ? 'inherit' : 'error.main' }}>
                            {val.toFixed(5)}
                          </TableCell>
                          ...
                          <TableCell align="right">
                            {rmse != null
                              ? <Chip label={rmse.toFixed(4)} size="small"
                                  sx={{ bgcolor: rmse < 0.015 ? '#E1F5EE'
                                    : rmse < 0.025 ? '#FAEEDA' : '#FCEBEB',
                                    color: rmse < 0.015 ? '#0F6E56'
                                    : rmse < 0.025 ? '#854F0B' : '#A32D2D',
                                    fontSize: 11 }} />
